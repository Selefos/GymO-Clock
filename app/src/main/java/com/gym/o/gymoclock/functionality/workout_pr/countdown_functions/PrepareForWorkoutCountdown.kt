...
var prepareCountdownInMillis: Long = 0 //by Delegates.notNull<Long>()
    ...
    prepareTimer = object : CountDownTimer(prepareCountdownInMillis, 1000) {
        ...
        override fun onFinish() {
            ...
            binding.playPauseButton.background =
                AppCompatResources.getDrawable(requireContext(), R.drawable.ic_pause_button)

            startTotalTimer()
            listAdapter.startExerciseTimer(com.gym.o.gymoclock.functionality.workout_pr.iterator)
