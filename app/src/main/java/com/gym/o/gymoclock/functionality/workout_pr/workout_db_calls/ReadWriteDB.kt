package com.gym.o.gymoclock.functionality.workout_pr.workout_db_calls
...
fun WorkoutFragment.saveExerciseValues(addOrUpdate: String, oldExerciseName: String, exerciseName: String, exerciseClock: TextView, restClock: TextView) {
...
fun WorkoutFragment.addEditExercise() {
    ...
    if (listAdapter.itemCount >= allowedExerciseNumber) {
        Toast.makeText(context, "Permitted exercise number exceeded", Toast.LENGTH_LONG).show()
        dialogBuilderUtils.dialog.dismiss()
        return
    }
